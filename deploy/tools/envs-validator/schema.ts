...
const securityReportSchema: yup.ObjectSchema<MarketplaceAppSecurityReportRaw> =
  yup.object({
  ...
  NEXT_PUBLIC_MARKETPLACE_CONFIG_URL: yup
    ...
    .when('NEXT_PUBLIC_MARKETPLACE_ENABLED', {
      ...
      otherwise: (schema) =>
        schema.max(
          -1,
          'NEXT_PUBLIC_MARKETPLACE_CONFIG_URL cannot not be used without NEXT_PUBLIC_MARKETPLACE_ENABLED',
        ),
    }),
  NEXT_PUBLIC_MARKETPLACE_CATEGORIES_URL: yup
    ...
    .when('NEXT_PUBLIC_MARKETPLACE_ENABLED', {
      ...
      otherwise: (schema) =>
        schema.max(
          -1,
          'NEXT_PUBLIC_MARKETPLACE_CATEGORIES_URL cannot not be used without NEXT_PUBLIC_MARKETPLACE_ENABLED',
        ),
    }),
  NEXT_PUBLIC_MARKETPLACE_SUBMIT_FORM: yup
    ...
    .when('NEXT_PUBLIC_MARKETPLACE_ENABLED', {
      ...
      otherwise: (schema) =>
        schema.max(
          -1,
          'NEXT_PUBLIC_MARKETPLACE_SUBMIT_FORM cannot not be used without NEXT_PUBLIC_MARKETPLACE_ENABLED',
        ),
    }),
  NEXT_PUBLIC_MARKETPLACE_SUGGEST_IDEAS_FORM: yup
    ...
    .when('NEXT_PUBLIC_MARKETPLACE_ENABLED', {
      ...
      otherwise: (schema) =>
        schema.max(
          -1,
          'NEXT_PUBLIC_MARKETPLACE_SUGGEST_IDEAS_FORM cannot not be used without NEXT_PUBLIC_MARKETPLACE_ENABLED',
        ),
    }),
  NEXT_PUBLIC_MARKETPLACE_SECURITY_REPORTS_URL: yup
    ...
    .when('NEXT_PUBLIC_MARKETPLACE_ENABLED', {
      ...
      otherwise: (schema) =>
        schema.max(
          -1,
          'NEXT_PUBLIC_MARKETPLACE_SECURITY_REPORTS_URL cannot not be used without NEXT_PUBLIC_MARKETPLACE_ENABLED',
        ),
    }),
  NEXT_PUBLIC_MARKETPLACE_FEATURED_APP: yup
    ...
    .when('NEXT_PUBLIC_MARKETPLACE_ENABLED', {
      ...
      otherwise: (schema) =>
        schema.max(
          -1,
          'NEXT_PUBLIC_MARKETPLACE_FEATURED_APP cannot not be used without NEXT_PUBLIC_MARKETPLACE_ENABLED',
        ),
    }),
  NEXT_PUBLIC_MARKETPLACE_BANNER_CONTENT_URL: yup
    ...
    .when('NEXT_PUBLIC_MARKETPLACE_ENABLED', {
      ...
      otherwise: (schema) =>
        schema.max(
          -1,
          'NEXT_PUBLIC_MARKETPLACE_BANNER_CONTENT_URL cannot not be used without NEXT_PUBLIC_MARKETPLACE_ENABLED',
        ),
    }),
  NEXT_PUBLIC_MARKETPLACE_BANNER_LINK_URL: yup
    ...
    .when('NEXT_PUBLIC_MARKETPLACE_ENABLED', {
      ...
      otherwise: (schema) =>
        schema.max(
          -1,
          'NEXT_PUBLIC_MARKETPLACE_BANNER_LINK_URL cannot not be used without NEXT_PUBLIC_MARKETPLACE_ENABLED',
        ),
    }),
  NEXT_PUBLIC_MARKETPLACE_RATING_AIRTABLE_API_KEY: yup
    ...
    .when('NEXT_PUBLIC_MARKETPLACE_ENABLED', {
      ...
      otherwise: (schema) =>
        schema.max(
          -1,
          'NEXT_PUBLIC_MARKETPLACE_RATING_AIRTABLE_API_KEY cannot not be used without NEXT_PUBLIC_MARKETPLACE_ENABLED',
        ),
    }),
  NEXT_PUBLIC_MARKETPLACE_RATING_AIRTABLE_BASE_ID: yup
    ...
    .when('NEXT_PUBLIC_MARKETPLACE_ENABLED', {
      ...
      otherwise: (schema) =>
        schema.max(
          -1,
          'NEXT_PUBLIC_MARKETPLACE_RATING_AIRTABLE_BASE_ID cannot not be used without NEXT_PUBLIC_MARKETPLACE_ENABLED',
        ),
    }),
});
...
const rollupSchema = yup.object().shape({
  ...
  NEXT_PUBLIC_ROLLUP_L1_BASE_URL: yup.string().when('NEXT_PUBLIC_ROLLUP_TYPE', {
    is: (value: string) => value,
    then: (schema) => schema.test(urlTest).required(),
    otherwise: (schema) =>
      schema.max(
        -1,
        'NEXT_PUBLIC_ROLLUP_L1_BASE_URL cannot not be used if NEXT_PUBLIC_ROLLUP_TYPE is not defined',
      ),
  }),
...
const adsBannerSchema = yup.object().shape({
  ...
  NEXT_PUBLIC_AD_BANNER_ADDITIONAL_PROVIDER: yup
    .string<AdBannerAdditionalProviders>()
    .oneOf(SUPPORTED_AD_BANNER_ADDITIONAL_PROVIDERS),
...
const deFiDropdownItemSchema: yup.ObjectSchema<DeFiDropdownItem> = yup
  ...
  .test(
    'oneOfRequired',
    'NEXT_PUBLIC_DEFI_DROPDOWN_ITEMS: Either dappId or url is required',
    function(value) {
...
const schema = yup
  ...
  .shape({
    ...
    NEXT_PUBLIC_NETWORK_VERIFICATION_TYPE: yup
      .string<NetworkVerificationTypeEnvs>()
    ...
    NEXT_PUBLIC_NAVIGATION_HIGHLIGHTED_ROUTES: yup
      ...
      .json()
      .of(yup.string()),
    NEXT_PUBLIC_NAVIGATION_LAYOUT: yup
      ...
      .test(
        ...
        (data) => {
          ...
          const isArrayOfMethodsSchema = yup
            ...
            .of(
              yup
                .string<SmartContractVerificationMethodExtra>()
                .oneOf(SMART_CONTRACT_EXTRA_VERIFICATION_METHODS),
            );

          return (
            isNoneSchema.isValidSync(data) ||
            isArrayOfMethodsSchema.isValidSync(data)
          );
        },
      ),
    ...
    NEXT_PUBLIC_API_SPEC_URL: yup
      ...
      .test(
        'shape',
        'Invalid schema were provided for NEXT_PUBLIC_API_SPEC_URL, it should be either URL-string or "none" string literal',
        (data) => {
          const isNoneSchema = yup.string().oneOf([ 'none' ]);
          ...
          return (
            isNoneSchema.isValidSync(data) ||
            isUrlStringSchema.isValidSync(data)
          );
        },
      ),
    ...
    NEXT_PUBLIC_GRAPHIQL_TRANSACTION: yup
      ...
      .test(
        'shape',
        'Invalid schema were provided for NEXT_PUBLIC_GRAPHIQL_TRANSACTION, it should be either Hex-string or "none" string literal',
        (data) => {
          const isNoneSchema = yup.string().oneOf([ 'none' ]);
          ...
          return (
            isNoneSchema.isValidSync(data) ||
            isHashStringSchema.isValidSync(data)
          );
        },
      ),
    ...
    NEXT_PUBLIC_MULTICHAIN_BALANCE_PROVIDER_CONFIG: yup
      ...
      .test(
        'shape',
        'Invalid schema were provided for NEXT_PUBLIC_MULTICHAIN_BALANCE_PROVIDER_CONFIG, it should have name and url template',
        (data) => {
          const isUndefined = data === undefined;
          const valueSchema = yup
            .object<MultichainProviderConfig>()
            .transform(replaceQuotes)
            .json()
            .shape({
              name: yup.string().required(),
    ...
    NEXT_PUBLIC_GAS_REFUEL_PROVIDER_CONFIG: yup
      ...
      .test(
        ...
        (data) => {
          const isUndefined = data === undefined;
          const valueSchema = yup
            .object<GasRefuelProviderConfig>()
            .transform(replaceQuotes)
            .json()
            .shape({
              name: yup.string().required(),
    ...
    NEXT_PUBLIC_VALIDATORS_CHAIN_TYPE: yup
      .string<ValidatorsChainType>()
      .oneOf(VALIDATORS_CHAIN_TYPE),
    NEXT_PUBLIC_GAS_TRACKER_ENABLED: yup.boolean(),
    NEXT_PUBLIC_GAS_TRACKER_UNITS: yup
      .array()
      .transform(replaceQuotes)
      .json()
      .of(yup.string<GasUnit>().oneOf(GAS_UNITS)),
    ...
    NEXT_PUBLIC_FAULT_PROOF_ENABLED: yup
      .boolean()
      .when('NEXT_PUBLIC_ROLLUP_TYPE', {
        is: 'optimistic',
        then: (schema) => schema,
    ...
    NEXT_PUBLIC_HAS_MUD_FRAMEWORK: yup
      .boolean()
      .when('NEXT_PUBLIC_ROLLUP_TYPE', {
        is: 'optimistic',
        then: (schema) => schema,
